...
export function getCrudapp2Program(provider: AnchorProvider) {
  return new Program(Crudapp2IDL as Crudapp2, provider)
}
...
export function getCrudapp2ProgramId(cluster: Cluster) {
  switch (cluster) {
    ...
    case 'testnet':
      ...
      return new PublicKey('Dckm24n22DmBxEUTZfV4zA3LTU5KhPnvsnYRJuZrMySY')
    case 'mainnet-beta':
    default:
